  ...
  \item 
    \begin{enumerate}[i)]
      ...
      \item Παρατηρούμε ότι $ a_{n}= \frac{1}{\sqrt{n^{2}+3}} \geq 0, 
        ...
        \begin{myitemize}
          \item $ n+1>n, \; \forall n \in \mathbb{N} \Leftrightarrow 
            {(n+1)^{2}} > {n^{2}}, \; \forall n \in \mathbb{N} 
            \Leftrightarrow  
            {(n+1)^{2} + 3} > {n^{2} + 3}, \; \forall n \in \mathbb{N} \Leftrightarrow 
            \sqrt{(n+1)^{2}+3} > \sqrt{n^{2}+3}, \; \forall n \in 
            \mathbb{N} \Leftrightarrow 
            \frac{1}{\sqrt{((n+1)^{2}+3)}} < \frac{1}{\sqrt{n^{2}+3}}, \; 
            \forall n \in \mathbb{N}
            \Leftrightarrow a_{n+1} < a_{n}, \; \forall n \in \mathbb{N}$, άρα η 
            $ a_{n}= \frac{1}{\sqrt{n^{2}+3}} $ είναι γνησίως φθίνουσα και άρα φθίνουσα.
          \item $ \lim_{n \to \infty} \frac{1}{\sqrt{n^{2}+3}} = 0 $
        \end{myitemize}
      ...
      \item $ \sum_{n=1}^{\infty} \left(- \frac{1}{2}\right)^{n} = 
        ...
        \begin{myitemize}
          ...
          \item $ \lim_{n \to \infty} \left(\frac{1}{2} \right)^{n} = 0 $
        \end{myitemize}
        Επομένως από κριτήριο Leibnitz η εναλλάσσουσα σειρά $ \sum_{n=1}^{\infty} 
